export default {
    ...
    viewBill: {
        ...
        userNotFound: 'User not found. Configure the user in the profile.',
        print: 'Print',
        printOptionsTitle: 'Where to print the bill?',
        printLocal: 'Print locally (Smart2)',
        printServer: 'Print on server',
        printLocalNotAvailable: 'Local printing only available on Smart2 device (Android build).',
        printLocalSuccess: 'Bill printed locally.',
        pay: 'Pay',
        close: 'Close',
        table: 'Table',
        total: 'Total',
        ...
        approachCard: 'Approach the card',
