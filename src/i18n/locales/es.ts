export default {
    ...
    viewBill: {
        ...
        userNotFound: 'Usuario no encontrado. Configure el usuario en el perfil.',
        print: 'Imprimir',
        printOptionsTitle: '¿Dónde imprimir la cuenta?',
        printLocal: 'Imprimir en local (Smart2)',
        printServer: 'Imprimir en servidor',
        printLocalNotAvailable: 'Impresión local solo disponible en dispositivo Smart2 (build Android).',
        printLocalSuccess: 'Cuenta impresa en local.',
        pay: 'Pagar',
        close: 'Cerrar',
        table: 'Mesa',
        total: 'Total',
        ...
        approachCard: 'Acerque la tarjeta',
